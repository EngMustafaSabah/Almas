                ...
                <div class="col-xl-12">
                    <div class="card custom-card">
                        <div class="card-header justify-content-between">
                            <div class="card-title">Tags Tables</div>
                            <a href="{{ route('dashboard.tags.create') }}" class="btn btn-primary">Add Tag</a>
                        </div>
                        <div class="card-body">
                                                ...
                                                <tr id="{{ 'row' . $item->id }}">
                                                    ...
                                                    <td>
                                                        <div class="hstack gap-2 fs-15">
                                                            ...
                                                            <a class="btn btn-icon btn-sm btn-danger-transparent rounded-pill delete-tag"
                                                                data-tag-id="{{ $item->id }}" href="#">
                                                                <i class="ri-delete-bin-line"></i>
                                                            </a>
                                                            <a href="{{ route('dashboard.tags.edit', ['tag' => $item->id]) }}"
...
@section('footerscript')
    <script>
        const deleteLinks = document.querySelectorAll('.delete-tag');
                ...
                if (confirm('Are you sure you want to delete this tag?')) {
                    fetch(`/dashboard/tags/${tagId}`, {
                        ...
                        .then(data => {
                            ...
                            location.reload()
                            document.getElementById("row" + tagId).remove();
                            // console.log(data);
                        })
                        .catch(error => {
