                            ...
                            <div class="card-body">
                                <div class="row gy-4">
                                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <input value="{{ old('tag_name_en') }}" name="tag_name_en" class="form-control" />
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                        <p class="mb-2 text-muted">Tag name AR:</p>
                                        <input value="{{ old('tag_name_ar') }}" name="tag_name_ar" class="form-control" />
                                    </div>
                                        ...
                                        <select class="form-select" id="basic-usage" data-placeholder="Choose one thing"
                                            ...
                                            @foreach ($data as $item)
                                                <option value="{{ $item->id }}">
                                                    {{ $item->getTranslation('tag_name', 'en') }}</option>
                                            @endforeach
                                        </select>
                                    </div>
