                            ...
                            <div class="card-body">
                                <div class="row gy-4">
                                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <input value="{{ old('title_en') }}" name="title_en" class="form-control" />
                                    </div>
                                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                        <p class="mb-2 text-muted">Title AR:</p>
                                        <input value="{{ old('title_ar') }}" name="title_ar" class="form-control" />
                                    </div>
                                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12"><label for="text-area"
                                        ...
                                        <textarea name="short_content_en" class="form-control" id="text-area" rows="6">{{ old('short_content_en') }}</textarea>
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12"><label for="text-area"
                                            class="form-label">short_description Ar:
                                        </label>
                                        <textarea name="short_content_ar" class="form-control" id="text-area" rows="6">{{ old('short_content_ar') }}</textarea>
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12"><label for="text-area"
                                            class="form-label">description_en En:
                                        </label>
                                        <textarea name="content_en" class="form-control" id="text-area" rows="6">{{ old('content_en') }}</textarea>
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12"><label for="text-area"
                                            class="form-label">description_en Ar:
                                        </label>
                                        <textarea name="content_ar" class="form-control" id="text-area" rows="6">{{ old('content_ar') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
